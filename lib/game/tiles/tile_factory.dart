...
// class TileFactory extends ObjectFactoryComponent<DustyTiles, TileEvent> {
...
//   @override
//   DustyTiles facotry(TileEvent message) {
//     return DustyTiles.normal();
//   }

//   @override
//   void onGenerateObject(TileEvent message) {
//     throw UnimplementedError('tile factory only supports onUpdateObject');
//   }

//   @override
//   void onRemoveObject(TileEvent message) {
//     // reset tile
...
//   @override
//   void onUpdateObject(TileEvent message) {
